...
HD_PWD='C:/School/Spring 2018/ECEN 449/Labs/Lab1_vivado2016/Lab1_vivado2016.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Jackpot.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Jackpot.tcl
