...
set rc [catch {
  ...
  add_files -quiet {{C:/School/Spring 2018/ECEN 449/Labs/Lab1_vivado2016/Lab1_vivado2016.runs/synth_1/Jackpot.dcp}}
  read_xdc {{C:/School/Spring 2018/ECEN 449/Labs/Jackpot.xdc}}
  link_design -top Jackpot -part xc7z010clg400-1
  write_hwdef -file Jackpot.hwdef
...
set rc [catch {
  ...
  catch { report_drc -file Jackpot_drc_routed.rpt -pb Jackpot_drc_routed.pb -rpx Jackpot_drc_routed.rpx }
  catch { report_methodology -file Jackpot_methodology_drc_routed.rpt -rpx Jackpot_methodology_drc_routed.rpx }
  ...
  catch { report_power -file Jackpot_power_routed.rpt -pb Jackpot_power_summary_routed.pb -rpx Jackpot_power_routed.rpx }
...
if {$rc} {
  write_checkpoint -force Jackpot_routed_error.dcp
...
set rc [catch {
  ...
  catch { write_mem_info -force Jackpot.mmi }
  write_bitstream -force -no_partial_bitfile Jackpot.bit 
  catch { write_sysdef -hwdef Jackpot.hwdef -bitfile Jackpot.bit -meminfo Jackpot.mmi -file Jackpot.sysdef }
